    ...
    return (
      ...
      >              
        <div className="header__site-menu_grid-container">
          ...
          <Link 
            className={`link  link_color_${this.props.contentsColor}  header__site-menu_grid-item header__menu_oryori`}
            onClick={this.props.handleOnClick}
            to='/oryori'
          >
            お料理
          ...
          <Link 
            className={`link  link_color_${this.props.contentsColor}  header__site-menu_grid-item header__menu_onsen`}
            onClick={this.props.handleOnClick}
            to='/onsen'
          >
            温泉
