        ...
        <div className="home-top__messages_flex-container">
          ...
          <div className="home-top__messages_flex-item">       
            <Slide direction="up" triggerOnce>
              <div className="home-top__messages_contents">温海温泉の</div>
              <div className="home-top__messages_contents_padding">美しさに癒やされて</div>
            </Slide>     
          </div>
          <div className="home-top__messages_flex-item">
            <Slide direction="up" triggerOnce>
              <div className="home-top__messages_contents">
          ...
          <div className="home-top__messages_flex-item">
            ...
            <Slide direction="up" triggerOnce>
            <div className="home-top__messages_contents">頑 張 る 現 代 人 に</div>
            </Slide>     
            <Slide direction="up" triggerOnce>
            <div className="home-top__messages_contents">
          ...
          <div className="home-top__messages_flex-item">
            <Slide direction="up" triggerOnce>
            <div className="home-top__messages_contents">石 井 花 壇</div>
            </Slide>     
          </div>
